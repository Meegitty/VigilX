...
void loop() {
  ...
  // --- C. DYNAMIC WEIGHTING & FUSION ---
  updateWeights();
  totalRiskScore = (wBlink * blinkScore) + (wTilt * tiltScore) + (wSpeed * speedScore);
  ...
  Serial.print("Score: "); Serial.print(totalRiskScore);
  Serial.print(" | W(B/T/S): "); Serial.print(wBlink); Serial.print("/"); 
  Serial.print(wTilt); Serial.print("/"); Serial.print(wSpeed);
  Serial.print(" | Blink: "); Serial.print(blinkScore);
  Serial.print(" | Tilt: "); Serial.print(tiltScore);
  Serial.print(" | Speed: "); Serial.print(speedScore);
